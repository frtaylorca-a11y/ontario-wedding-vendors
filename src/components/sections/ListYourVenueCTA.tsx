    ...
    <section className="bg-charcoal">
      <div className="mx-auto flex max-w-[1100px] flex-col items-center gap-6 px-6 py-16 text-center md:flex-row md:justify-between md:gap-10 md:text-left">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-pill bg-rose px-7 py-3.5 font-bold text-white shadow-[0_8px_24px_rgba(185,100,118,0.35)] transition-all duration-200 hover:bg-rose-hover hover:shadow-[0_12px_32px_rgba(185,100,118,0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose focus-visible:ring-offset-2 focus-visible:ring-offset-charcoal"
        >
          Get listed free
